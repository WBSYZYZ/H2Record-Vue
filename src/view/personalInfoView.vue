<template>
    <el-dialog v-model="addVisible" :draggable="true" class="personalInfoDialog">
        <div class="card" data-state="#about">
            <div class="card-header">
                ...
                <h1 class="card-fullname">{{ nickName }}</h1>
                <h2 class="card-jobtitle">{{ post }}</h2>
            </div>
            <div class="card-main">
                <div class="card-section is-active" id="about">
                    <div class="card-content">
                        <div class="card-subtitle">ABOUT</div>
                        <p class="card-desc">{{ intro }}
                        </p>
                    </div>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-timeline">
                            <div class="card-item" v-for="item in experience" :key="item.year">
                                <div class="card-item-data-year" :data-year="item.year">
                                </div>
                                <div class="card-item-title">{{ item.company }}
                                </div>
...
export default {
    ...
    setup(props) {
        ...
        const UserBasicInfoData = reactive({
            ...
            post: props.basicVal.post==""?"职位":props.basicVal.post,
            nickName: props.basicVal.nickName,
            address: props.basicVal.address==""?"地址":props.basicVal.address,
            email: props.basicVal.email==""?"邮箱":props.basicVal.email,
            intro: props.basicVal.intro==""?"简介":props.basicVal.intro,
...
<style scoped>
@import url("../components/css/personalInfo-dialog.css");
@import url("../components/css/personalInfo-style.css");
</style>